  ...
  return (
    <div style={{ paddingTop: "2rem" }}>
      ...
      <ul>
        ...
        <li>
          The tool is intended for research purposes only and should not be used
          as a basis for clinical diagnosis or treatment decisions.
        </li>
        <li>
          It has not been approved for clinical use by any regulatory bodies.
        </li>
        <li>
          No personal data is collected by the tool, and the prediction results
          are processed in a Hugging Face environment based on user inputs.
        </li>
      </ul>
      <p>
        Please see{" "}
